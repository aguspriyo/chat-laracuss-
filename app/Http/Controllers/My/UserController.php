...
class UserController extends Controller
{
  public function show($username)
  {
    ...
    //get discussion berdasarkan id user dan get dengan paginasi per 5 row
    // return view
...
//return view
  ...
  public function update(UpdateRequest $request, $username)
  {
    ...
    //jika memang bukan maka hapus dulu picture tsb dari disk stroge kita
