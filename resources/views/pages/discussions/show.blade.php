                ...
                <div class="col-12 col-lg-8 mb-5 mb-lg-0">
                        ...
                        <div class="row">
                            <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                                <a id="discussion-like" href="javascript:;" data-liked="{{ $discussion->liked() }}">
                                    <img src="{{ $discussion->liked() ? $likedImage : $notLikeImage }}" alt="Like"
                            ...
                            <div class="col-11">
                                ...
                                <div class="mb-3">
                                    <a href="{{ route('discussions.categories.show', $discussion->category->slug) }}"><span
                                            ...
                                            {{ $discussion->category->slug }}</span></a>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                                        <a href="javascript:;" data-id="{{ $answer->id }}"
                                            ...
                                            <img src="{{ $answer->liked() ? $likedImage : $notLikeImage }}" alt="Like"
                                        ...
                                        <div class="row align-items-end justify-content-end">
                                            <div class="col">
                                                ...
                                                @if ($answer->user_id === auth()->id())
                                                    <span class="color-gray me-2">
                                                        <a
                                                            href="{{ route('answers.edit', $answer->id) }}"><small>Edit</small></a>
                                                    </span>
                                                    ...
                                                    <form action="{{ route('answers.destroy', $answer->id) }}"
                                                        ...
                                                        <button type="submit"
                                                            class="delete-answer color-gray btn btn-link text-decoration-none p-0 lh-1"><small>Delete</small></button>
                                                    </form>
                                                @endif
                                            </div>
                                            <div class="col-5 col-lg-3 d-flex">
                                                ...
                                                <div class="fs-12px lh-1">
                                                    <span
                                                        class="{{ $answer->user->username === $discussion->user->username ? 'text-primary' : '' }}"><a
                                                            href="#"
                                                            class="fw-bold d-flex align-items-start text-break mb-1">
                                                            {{ $answer->user->username }}</a></span>
                                                    <span
                    ...
                    @guest
                        ...
                        <div class="fw-bold text-center">Please <a href="{{ route('auth.login.show') }}"
                                ...
                                class="text-primary">create an account</a> to participate in this
                            discussion.</div>
                    @endguest
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#discussion-like').click(function() {
                //dapatkan data apakah discussion ini pernah dilike user
                //tentukan route like ajax, berdasarkan dengan apakah ini sudah di like atau belum
                //lakukan proses ajax
                //jika ajax berhasil maka dapatkan status jsonnya
                //jika statusnya success maka isi counter like dengan data counter like jsonnya
                //lalu kita ganti icon likenya berdasarkan dengan nilai variabel poin 1
                ...
                $.ajax({
                    ...
                    .done(function(res) {
                        if (res.status === 'success') {
                            ...
                            if (isLiked) {
                                $('#discussion-like-icon').attr('src', '{{ $notLikeImage }}')
                            } else {
                ...
                $.ajax({
                    ...
                    .done(function(res) {
                        if (res.status === 'success') {
                            ...
                            if (isLiked) {
                                $this.find('.answer-like-icon').attr('src', '{{ $notLikeImage }}')
                            } else {
