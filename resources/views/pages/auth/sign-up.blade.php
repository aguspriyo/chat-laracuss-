            ...
            <div class="row pt-5 justify-content-center">
                ...
                <div class="col-12 col-lg-3 h-100">
                    <a href="#" class="nav-link mb-5 text-center">
                        <img src="{{ url('assets/images/logolaracussbiru.png') }}" alt="Logo Laracuss" class="h-32px">
                    </a>
                    <div class="card mb-5">
                        <form action="{{ route('auth.sign-up.sign-up') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="email" name="email" placeholder="name@email.com" autocomplete="off" autofocus
                                    value="{{ old('email') }}">
                                @error('email')
                                ...
                                <div class="input-group">
                                    ...
                                    <span
                                        ...
                                        <a href="javascript:;" id="password-toggle">
                                            <img src="{{ url('assets/images/eyeslash.png') }}" alt="Password Toggle"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror"
                                    id="username" name="username" placeholder="your name" autocomplete="off"
                                    value="{{ old('username') }}">
                                @error('username')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="text-center">
                        Already have an account? <a href="{{ route('auth.login.show') }}">
                            <u>Log in</u>
                        </a>
                    </div>
                </div>
    ...
    <script>
        ...
        $('#password-toggle').on('click', function() {
            ...
            if (isPasswordRevealed) {
                ...
                $('#password-toggle-img').attr('src', '{{ url('assets/images/eyeslash.png') }}')
