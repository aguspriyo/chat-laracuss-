<nav class="navbar navbar-dark navbar-expand-lg bg-primary">
    <div class="container flex justify-content-between">
        <a class="navbar-link" href="{{ route('home') }}">
            <img class="h-32px" src="{{ url('assets/images/logolaracuss.png') }}" alt="Laracuss logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex w-100 me-4 my-2 my-lg-0" action="{{ route('discussions.index') }}" method="GET"
                role="search">
                <div class="input-group">
                    <span class="input-group-text bg-white boreder-end-0"><img
                            src="{{ url('assets/images/searchlogo.png') }}" alt="Search"></span>
            ...
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                ...
                @auth
                    <li class="nav-item my-auto dropdown">
                        <a class="nav-link p-0 d-flex align-items-center" aria-current="page" href="javascript:;"
